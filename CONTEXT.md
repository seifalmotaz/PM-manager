...
- Status transitions — resolved: **adjacent only** following standard Scrum. `todo ↔ in_progress ↔ review ↔ done`. No jumps (e.g., `todo → done`). Drag-and-drop in Kanban validates transitions; invalid drops show an error toast.
