<script lang="ts">
	...
	let { isOpen, isLoading, workspace, onClose, onSubmit }: Props = $props()
	...
	<div class="modal-overlay" onclick={handleBackdropClick} role="dialog" aria-modal="true">
		<div class="modal-card">
			<div class="modal-header">
				<h2 class="modal-title">Rename workspace</h2>
			...
			<form onsubmit={handleSubmit}>
				...
				<div class="form-actions">
					...
					<button type="submit" class="btn-submit" disabled={!name.trim() || name === workspace?.name || isLoading}>
						{#if isLoading}
							Saving...
						{:else}
							Save changes
